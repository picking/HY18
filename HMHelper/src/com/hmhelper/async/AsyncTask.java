...
public abstract class AsyncTask<Params, Progress, Result> {
	 ...
	 */
	public static final ThreadPoolExecutor mCachedSerialExecutor = new ThreadPoolExecutor(CORE_POOL_SIZE, MAXIMUM_POOL_SIZE, KEEP_ALIVE, TimeUnit.SECONDS, sPoolWorkQueue, sThreadFactory);
	 ...
	 * This method must be invoked on the UI thread.
	 * 
	 * @param exec The executor to use. {@link #mCachedSerialExecutor} is
